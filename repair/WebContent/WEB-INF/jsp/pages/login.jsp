...
<html lang="en">
  ...
  <body class="login">
	<div class="logo">
		<h2 style="color: white;">山东速修信息</h2>
	</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix boxH" type="text" placeholder="请输入用户名" name="username" value="admin"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix boxH" type="password" placeholder="请输入密码" name="password" value="123"/>
					</div>
				</div>
			</div>
